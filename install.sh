#!/bin/bash -e
#
# Wan's dotfile installer. Usage:
#
#   curl http://github.com/compbrain/dotfiles/raw/master/install.sh | sh
#
# or:
#
#   ~/.dotfiles/install.sh
...
bindir=$HOME/bin
gitbase=git://github.com/compbrain/dotfiles.git
tarball=http://github.com/compbrain/dotfiles/tarball/master
